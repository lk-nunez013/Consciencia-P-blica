     ...
     <br><br><br><br>
      ...
      <div class="card">
        <div class="card-body" align="left">
          <H1>Listar prefeito</H1>
        </div>
      </div>
      </section>
         <section class="jumbotron text-left">
        <div class="container">
          <p class="lead text-muted">Listagem de prefeitos.</p>
               ...
               <div class="table-responsive">
                    <table class="table table-hover">
                          ...
                          <tbody>                      
                            ...
                            $sql = "select * from tb_prefeito";
                            //pegando os dados da tabela. Executando query
                            $resultado = mysqli_query($conexao, $sql);
                            while($linha = mysqli_fetch_array($resultado))
                            {
                               echo '<tr>';                  
                                   echo  '<td>'.$linha['cd_prefeito'].'</td>';
                                   echo  '<td>'.$linha['nm_prefeito'].'</td>';
                                   echo  '<td>'.$linha['cd_rg'].'</td>';
