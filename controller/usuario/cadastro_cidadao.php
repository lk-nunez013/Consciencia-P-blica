							  ...
							  <div class="jumbotron">
								  ...
								  <form action="cadastro_usuario.php" method="post">
									  <div class="form-group">
										...
										<input type="text" class="form-control" name="c_nome" placeholder="Digite seu nome:">
								  	 </div>
								   <div class="form-group">
										<label for="c_email">Email:</label>
										<input type="email" class="form-control" name="c_email" placeholder="Digite seu email">
								  	 </div>
									  <div class="form-group">
										<label for="exampleInputPassword1">Senha:</label>
										<input type="password" class="form-control" id="exampleInputPassword1" name="c_senha"placeholder="Senha">
									  </div>
