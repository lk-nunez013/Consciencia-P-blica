     ...
     <br><br><br><br>
      ...
      <div class="card">
        <div class="card-body" align="left">
          <H1>PROJETOS DOS VEREADORES</H1>
        </div>
      </div>
      </section>
         <section class="jumbotron text-left">
        <div class="container">
          <p class="lead text-muted">Listagem de projetos para solucionar os problemas dos cidadãos. Avalie e comente caso te interesse que a proposta vire projeto. Aqui, você verifica se os vereadores e prefeitos mantém o foco no prometido durante as campanhas e o que realmente é feito por eles.</p>
          <p>
            <a href="#" class="btn btn-primary"> Buscar projetos de vereadores</a>
          </p>
               ...
               <div class="table-responsive">
                    <table class="table table-hover">
                          ...
                          <tbody>                      
                            ...
                            $sql = "select distinct * from tb_problema as prob, tb_categoria as c, tb_vereador as v, tb_solucao as s, tb_relevancia as r, tb_projeto as p, tb_historico as h, tb_prefeito as pre, tb_aprovada as a";
